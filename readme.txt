...
This Sudoku solver is implemented in Python 2.7.3, using two different classes to represent the actual Sudoku grid, the ‘Node’ class and the ‘Sudoku_Matrix’ class. 
